  ...
  try {
    ...
    res.json({
      ...
      totals: {
        ...
        // Xarajat CRM valyutasiga o'girilgandan keyin bo'linadi;
        // kurs yo'q bo'lsa spendInCrmCurrency null qaytaradi.
        roas: (() => {
          const spend = spendInCrmCurrency(t.spend, guard);
          return spend !== null && spend > 0 ? t.revenue / spend : null;
        })(),
